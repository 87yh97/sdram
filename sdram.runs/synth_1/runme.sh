...
HD_PWD='C:/VIVADO_PROJECTS/sdram/sdram.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log pll_inst.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source pll_inst.tcl
